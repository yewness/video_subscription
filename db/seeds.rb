...
Category.create(name: "Primary Lower(Standard 1)")
Category.create(name: "Primary Lower(Standard 2)")
Category.create(name: "Primary Lower(Standard 3)")
Category.create(name: "Primary Upper(Standard 4)")
Category.create(name: "Primary Upper(Standard 5)")
Category.create(name: "Primary Upper(Standard 6)")
Category.create(name: "Secondary Lower(Form 1)")
Category.create(name: "Secondary Lower(Form 2)")
Category.create(name: "Secondary Lower(Form 3)")